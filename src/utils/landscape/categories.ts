...
export const themeCategories: Category[] = [
  {
    ...
    children: [
      { id: 'mountain', name: '山峦', icon: '🏔️', description: '山峰、山脊、山脉' },
      { id: 'valley', name: '峡谷', icon: '⛰️', description: '峡谷、沟壑、断崖' },
      { id: 'forest', name: '森林', icon: '🌲', description: '森林、树林、竹林' },
      { id: 'grassland', name: '草原', icon: '🌾', description: '草原、牧场' },
      { id: 'desert', name: '沙漠', icon: '🏜️', description: '沙漠、戈壁、沙丘' },
      { id: 'glacier', name: '冰川', icon: '🧊', description: '冰川、冰山、雪峰' },
      { id: 'field', name: '田野', icon: '🌾', description: '麦田、稻田、梯田' },
    ]
  },
  {
    id: 'water',
    ...
    description: '江河湖海的壮丽',
    children: [
      { id: 'ocean', name: '海洋', icon: '🌊', description: '大海、海岸、海浪' },
      { id: 'lake', name: '湖泊', icon: '🏞️', description: '湖泊、池塘、水库' },
      { id: 'river', name: '河流', icon: '🏞️', description: '河流、溪流、江河' },
      { id: 'waterfall', name: '瀑布', icon: '💧', description: '瀑布、溪流、泉水' },
      { id: 'beach', name: '海滩', icon: '🏖️', description: '沙滩、海岸、岛屿' },
      { id: 'wetland', name: '湿地', icon: '🦆', description: '湿地、沼泽、滩涂' },
    ]
  },
  {
    id: 'sky',
    ...
    description: '天空的变幻莫测',
    children: [
      { id: 'clouds', name: '云彩', icon: '☁️', description: '云层、云雾' },
      { id: 'cloud-sea', name: '云海', icon: '🌫️', description: '云海翻涌、云瀑' },
      { id: 'morning-glow', name: '朝霞', icon: '🌅', description: '日出朝霞、晨光熹微' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'architecture', name: '建筑', icon: '🏛️', description: '建筑、地标、摩天楼' },
      { id: 'street', name: '街景', icon: '🛣️', description: '街道、巷弄、广场' },
      { id: 'nightview', name: '夜景', icon: '🌃', description: '城市夜景、灯光' },
      { id: 'bridge', name: '桥梁', icon: '🌉', description: '桥梁、高架、立交' },
    ]
  },
  {
    id: 'season',
    ...
    description: '季节的独特魅力',
    children: [
      { id: 'spring', name: '春季', icon: '🌸', description: '春花、新绿、生机' },
      { id: 'summer', name: '夏季', icon: '☀️', description: '夏日、绿荫、活力' },
      { id: 'autumn', name: '秋季', icon: '🍁', description: '秋叶、金黄、收获' },
      { id: 'winter', name: '冬季', icon: '❄️', description: '冬雪、冰霜、宁静' },
    ]
  },
  {
    id: 'cultural',
    ...
    description: '人文历史景观',
    children: [
      { id: 'ruins', name: '遗迹', icon: '🏚️', description: '废墟、遗址、古建筑' },
      { id: 'garden', name: '园林', icon: '🌿', description: '公园、植物园、中式园林' },
...
export const locationCategories: Category[] = [
  {
    ...
    description: '中华大地的壮美',
    children: [
      { id: 'china-west', name: '西部', icon: '🏔️', description: '西藏、新疆、青海、甘肃' },
      { id: 'china-south', name: '南方', icon: '🌿', description: '云南、贵州、广西、海南' },
      { id: 'china-north', name: '北方', icon: '❄️', description: '内蒙古、黑龙江、吉林、辽宁' },
      { id: 'china-east', name: '东部', icon: '🌊', description: '浙江、江苏、福建、山东' },
      { id: 'china-central', name: '中部', icon: '⛰️', description: '四川、重庆、湖北、湖南' },
      { id: 'china-island', name: '岛屿', icon: '🏝️', description: '台湾、海南、舟山' },
  ...
  },
  {
    ...
    description: '亚洲的多元风情',
    children: [
      { id: 'japan', name: '日本', icon: '🇯🇵', description: '樱花、富士山、古镇' },
      { id: 'korea', name: '韩国', icon: '🇰🇷', description: '首尔、济州岛' },
      { id: 'southeast', name: '东南亚', icon: '🌴', description: '泰国、越南、印尼、菲律宾' },
      { id: 'india', name: '印度', icon: '🇮🇳', description: '泰姬陵、恒河、喜马拉雅' },
      { id: 'middle-east', name: '中东', icon: '🕌', description: '迪拜、以色列、土耳其' },
    ]
  },
  {
    id: 'europe',
    ...
    description: '欧洲的古典浪漫',
    children: [
      { id: 'western-europe', name: '西欧', icon: '🏰', description: '法国、英国、德国、荷兰' },
      { id: 'southern-europe', name: '南欧', icon: '🌊', description: '意大利、西班牙、希腊' },
      { id: 'northern-europe', name: '北欧', icon: '❄️', description: '冰岛、挪威、瑞典、芬兰' },
      { id: 'eastern-europe', name: '东欧', icon: '🏔️', description: '俄罗斯、波兰、捷克' },
    ]
  },
  {
    id: 'america',
    ...
    children: [
      ...
      { id: 'central-america', name: '中美', icon: '🏝️', description: '古巴、巴拿马、哥斯达黎加' },
    ]
  },
  {
    id: 'africa',
    ...
    description: '非洲的狂野之美',
    children: [
      { id: 'north-africa', name: '北非', icon: '🏜️', description: '埃及、摩洛哥、突尼斯' },
      { id: 'east-africa', name: '东非', icon: '🦁', description: '肯尼亚、坦桑尼亚、埃塞俄比亚' },
      { id: 'south-africa', name: '南非', icon: '🌿', description: '南非、纳米比亚、津巴布韦' },
    ]
  },
  {
    id: 'oceania',
    ...
    children: [
      { id: 'australia', name: '澳大利亚', icon: '🇦🇺', description: '大堡礁、悉尼、墨尔本' },
      { id: 'new-zealand', name: '新西兰', icon: '🇳🇿', description: '南岛、北岛、霍比特村' },
      { id: 'pacific', name: '太平洋岛国', icon: '🏝️', description: '斐济、帕劳、大溪地' },
    ]
  },
  {
    id: 'polar',
    ...
    description: '极地的纯净世界',
    children: [
      { id: 'arctic', name: '北极', icon: '🐻‍❄️', description: '北极圈、格陵兰、斯瓦尔巴' },
...
// ============================================
// 一级分类：时间分类
// 时间段划分：黎明→日出→上午→正午→下午→黄金时刻→黄昏→日落→蓝调时刻→深夜→午夜
// 各时间段互斥，同一作品可能同时符合多个维度（如拍摄于黄金时刻的照片也可被"白天"筛选）
// ============================================
export const timeCategories: Category[] = [
  {
    ...
    children: [
      ...
      { id: 'golden-hour', name: '黄金时刻', icon: '✨', description: '日出后/日落前的黄金光线(约1小时)' },
    ]
  },
  {
    id: 'nighttime',
    ...
    description: '夜晚的神秘魅力',
    children: [
      { id: 'dusk', name: '黄昏', icon: '🌆', description: '日落前的昏黄暮色(16:00-18:00)' },
      { id: 'sunset-time', name: '日落', icon: '🌇', description: '太阳落下时分(18:00-19:00)' },
      { id: 'blue-hour', name: '蓝调时刻', icon: '💙', description: '日出前/日落后的蓝调时段(约30分钟)' },
...
export const weatherCategories: Category[] = [
  {
    ...
    description: '晴朗的好天气',
    children: [
      { id: 'sunny', name: '晴天', icon: '☀️', description: '晴朗无云' },
    ]
  },
  {
    id: 'cloudy-weather',
  ...
  },
  {
    ...
    description: '极端天气现象',
    children: [
      { id: 'storm', name: '风暴', icon: '⛈️', description: '风暴天气' },
      { id: 'lightning', name: '雷电', icon: '⚡', description: '雷电交加' },
...
export const techniqueCategories: Category[] = [
  {
    ...
    children: [
      ...
      { id: 'symmetry', name: '对称', icon: '⚖️', description: '对称构图' },
      { id: 'framing', name: '框架', icon: '🖼️', description: '框架构图' },
      { id: 'minimalist-composition', name: '极简构图', icon: '⬜', description: '极简构图法' },
      { id: 'golden-ratio', name: '黄金比例', icon: '📐', description: '黄金分割构图' },
    ]
  },
  {
    id: 'exposure',
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'low-angle', name: '低角度', icon: '⬇️', description: '低角度拍摄' },
      { id: 'high-angle', name: '高角度', icon: '⬆️', description: '高角度俯拍' },
      { id: 'panorama', name: '全景', icon: '🔄', description: '全景接片' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'focus-stacking', name: '景深合成', icon: '🎯', description: '多焦距景深合成' },
      { id: 'filter-usage', name: '滤镜', icon: '🔲', description: 'ND、GND、CPL滤镜' },
    ]
  },
];
...
export const styleCategories: Category[] = [
  {
    ...
    description: '色彩的表现',
    children: [
      { id: 'warm-tone', name: '暖色调', icon: '🔥', description: '红橙黄色系' },
      { id: 'cool-tone', name: '冷色调', icon: '❄️', description: '蓝绿紫色系' },
      { id: 'vibrant', name: '鲜艳', icon: '🌈', description: '高饱和度' },
      { id: 'muted', name: '柔和', icon: '🎨', description: '低饱和度' },
      { id: 'monochrome', name: '单色', icon: '⚫', description: '单色调' },
    ]
  },
  {
    id: 'mood',
    ...
    children: [
      ...
      { id: 'peaceful', name: '宁静', icon: '🕊️', description: '宁静祥和' },
      { id: 'mysterious', name: '神秘', icon: '🌙', description: '神秘氛围' },
      { id: 'romantic', name: '浪漫', icon: '💕', description: '浪漫唯美' },
      { id: 'powerful', name: '震撼', icon: '💪', description: '震撼壮观' },
    ]
  },
  {
    id: 'artistic',
...
export const elementCategories: Category[] = [
  {
    ...
    description: '自然界的元素',
    children: [
      { id: 'single-tree', name: '孤树', icon: '🌳', description: '单株树木、孤树' },
      { id: 'flowers', name: '花卉', icon: '🌸', description: '花卉、花海' },
      { id: 'rocks', name: '岩石', icon: '🪨', description: '岩石、石林' },
      { id: 'ice', name: '冰雪', icon: '❄️', description: '冰雪、冰川' },
...
export const categoryGroups: CategoryGroup[] = [
  ...
  { key: 'style', name: '风格', icon: '🎨', description: '按摄影风格分类', categories: styleCategories },
