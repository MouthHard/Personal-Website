  ...
  <section class="module-ranking">
      ...
      <div class="header-controls">
        <div class="filters-group">
          <div class="filter-item">
            ...
            <div
              class="custom-select"
              :class="{ 'open-select': openSelect === 'price' }"
            >
          ...
          <div class="filter-item">
            ...
            <div
              class="custom-select"
              :class="{ 'open-select': openSelect === 'rating' }"
            >
          ...
          <div class="filter-item">
            ...
            <div
              class="custom-select"
              :class="{ 'open-select': openSelect === 'category' }"
            >
        ...
        <div class="sort-control">
          ...
          <div
            class="custom-select"
            :class="{ 'open-select': openSelect === 'sort' }"
          >
    ...
    <div class="grid-area-ranking">
      ...
      <div v-else class="foods-container">
        <article
          v-for="(food, index) in filteredAndSortedFoods.slice(0, 4)"
          :key="food.id"
          class="food-card"
          :class="{
            'gold-medal': index === 0,
          ...
          <div class="card-content">
            ...
            <div class="food-info">
              ...
              <div class="food-tags">
                ...
                <span
                  v-for="(tag, tagIndex) in (food.tags || []).slice(0, 2)"
                  :key="tagIndex"
                  class="food-tag"
                >
                  {{ tag }}
  ...
  const applyFilters = (foods: Food[]) => {
    return foods.filter((food: Food) => {
      ...
      if (selectedPriceFilter.value !== 'all') {
        ...
        if (max === undefined) {
          if (!food.price || food.price < parseInt(min)) return false;
        } else {
          if (
            !food.price ||
            food.price < parseInt(min) ||
            food.price > parseInt(max)
          )
            return false;
        }
      }
    ...
    switch (selectedSort.value) {
      ...
      case 'price-asc':
        return sortedFoods.sort(
          (a: Food, b: Food) => (a.price || 0) - (b.price || 0),
        );
      case 'price-desc':
        return sortedFoods.sort(
          (a: Food, b: Food) => (b.price || 0) - (a.price || 0),
        );
      case 'reviews':
        return sortedFoods.sort(
          (a: Food, b: Food) =>
