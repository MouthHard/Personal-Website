...
const hongkongNatureSpots: ScenerySpot[] = [
  ...
  },
  {
    id: "rePulseBay",
    name: "浅水湾",
    description: "香港特别行政区的著名海滩，以其美丽的海滩和豪华的住宅而闻名",
...
// 香港特别行政区人文景观数据
const hongkongCultureSpots: ScenerySpot[] = [
  {
  ...
  },
  {
    ...
    name: "香港历史博物馆",
    description: "香港特别行政区的著名博物馆，以其丰富的历史文物和文化而闻名",
...
// 香港特别行政区季节性数据
const hongkongSeasonalData: Record<string, SeasonalScenery> = {
  spring: {
    name: "春季",
...
// 香港特别行政区活动数据
const hongkongActivities: TravelActivity[] = [
  {
    id: "1",
    name: "维多利亚港赏夜景",
    description: "在维多利亚港欣赏美丽的夜景，感受香港的繁华",
  ...
  },
  {
    id: "2",
    name: "太平山顶缆车体验",
    description: "乘坐太平山顶缆车，欣赏香港的城市景观",
  ...
  },
  {
    id: "3",
    name: "香港迪士尼乐园游玩",
    description: "在香港迪士尼乐园享受各种娱乐设施和表演",
  ...
  },
  {
    id: "4",
    name: "香港海洋公园游玩",
    description: "在香港海洋公园欣赏各种海洋动物和娱乐设施",
  ...
  },
  {
    id: "5",
    name: "香港美食之旅",
    description: "品尝香港特色美食，如港式点心、烧腊、奶茶等",
...
// 香港特别行政区路线数据
const hongkongRoutes: RouteInfo[] = [
  {
    id: "1",
    name: "香港主题公园之旅",
    title: "香港主题公园之旅",
    description: "探索香港的著名主题公园",
    duration: "3天",
    difficulty: "简单",
    highlights: ["香港迪士尼乐园", "香港海洋公园", "维多利亚港", "太平山顶"],
    spots: ["香港迪士尼乐园", "香港海洋公园", "维多利亚港", "太平山顶"],
    tags: ["娱乐", "主题公园", "城市景观"],
  ...
  },
  {
    ...
    name: "香港自然风光之旅",
    title: "香港自然风光之旅",
    description: "探索香港的自然风光",
    duration: "2天",
    difficulty: "中等",
    highlights: ["大屿山", "西贡郊野公园", "浅水湾", "维多利亚港"],
    spots: ["大屿山", "西贡郊野公园", "浅水湾", "维多利亚港"],
    tags: ["自然", "风景", "户外活动"],
...
// 香港特别行政区非物质文化遗产数据
const hongkongIntangibleHeritage = [
  {
    id: "1",
    name: "粤剧",
    ...
    category: "传统戏剧",
    heritageType: "传统表演艺术",
    protectionUnit: "香港特别行政区文化体育及旅游局",
  ...
  },
  {
    id: "2",
    name: "凉茶制作技艺",
    description: "香港特别行政区传统手工艺，以其独特的制作工艺和保健功效著称",
    level: "national",
    category: "传统技艺",
    heritageType: "传统手工艺",
    protectionUnit: "香港特别行政区文化体育及旅游局",
...
// 香港特别行政区文化节庆数据
export const hongkongFestivals = [
  {
    id: "1",
    name: "香港新年倒数",
    description: "香港举行的新年倒数活动，是香港最具代表性的节庆活动之一",
    month: "12月",
    day: "31日",
    location: "香港特别行政区维多利亚港",
    isUnique: true
