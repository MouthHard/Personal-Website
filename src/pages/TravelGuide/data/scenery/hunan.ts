...
// 湖南省人文景观数据
const hunanCultureSpots: ScenerySpot[] = [
  {
    id: "changshaMuseum",
    name: "长沙博物馆",
    description: "湖南省长沙市的著名博物馆，以其丰富的历史文物和文化而闻名",
  ...
  },
  {
    ...
    name: "湘潭毛泽东故居",
    description: "湖南省湘潭市的著名革命纪念地，以其丰富的革命历史和文化而闻名",
...
// 湖南省季节性数据
const hunanSeasonalData: Record<string, SeasonalScenery> = {
  spring: {
    name: "春季",
...
// 湖南省活动数据
const hunanActivities: TravelActivity[] = [
  {
    id: "1",
    name: "张家界登山",
    description: "攀登张家界，欣赏壮丽的自然风光和独特的地质景观",
  ...
  },
  {
    id: "2",
    name: "凤凰古城夜游",
    description: "在凤凰古城夜游，欣赏美丽的夜景和独特的民俗文化",
  ...
  },
  {
    id: "4",
    name: "德夯大峡谷探险",
    description: "探险德夯大峡谷，欣赏壮丽的自然风光和独特的民俗文化",
  ...
  },
  {
    id: "5",
    name: "湖南美食之旅",
    description: "品尝湖南特色美食，如长沙臭豆腐、湘西腊肉、岳阳小龙虾等",
...
// 湖南省路线数据
const hunanRoutes: RouteInfo[] = [
  {
    id: "1",
    name: "湖南山水风光之旅",
    title: "湖南山水风光之旅",
    description: "游览湖南最著名的山水景观",
    duration: "5天",
    difficulty: "中等",
    highlights: ["张家界", "武陵源", "德夯大峡谷", "洞庭湖"],
    spots: ["张家界", "武陵源", "德夯大峡谷", "洞庭湖"],
    tags: ["自然", "山水", "休闲"],
  ...
  },
  {
    ...
    name: "湖南文化遗产之旅",
    title: "湖南文化遗产之旅",
    description: "探索湖南的文化遗产",
    duration: "4天",
    difficulty: "简单",
    highlights: ["凤凰古城", "韶山", "岳阳楼", "长沙橘子洲"],
    spots: ["凤凰古城", "韶山", "岳阳楼", "长沙橘子洲"],
    tags: ["历史", "文化", "建筑"],
...
const hunanIntangibleHeritage = [
  ...
  },
  {
    ...
    category: "传统舞蹈",
    heritageType: "传统表演艺术",
    protectionUnit: "湖南省湘西土家族苗族自治州文化和旅游局",
...
export const hunanCustomsData = {
  activities: [
    ...
    },
    {
      id: "4",
      name: "浏阳花炮制作体验",
      description: "学习湖南省浏阳市传统花炮制作技艺，体验其独特的魅力",
