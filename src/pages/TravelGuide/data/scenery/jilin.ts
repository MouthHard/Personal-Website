...
// 吉林省人文景观数据
const jilinCultureSpots: ScenerySpot[] = [
  {
    id: "changchunPuppetShowTheater",
    name: "长春木偶剧院",
    description: "吉林省长春市的著名木偶剧院，以其精美的木偶表演而闻名",
  ...
  },
  {
    id: "jilinMuseum",
    name: "吉林省博物馆",
    description: "吉林省最大的综合性博物馆，以其丰富的馆藏和精美的展览而闻名",
  ...
  },
  {
    ...
    name: "长春电影制片厂",
    description: "中国著名的电影制片厂，以其丰富的电影历史和文化而闻名",
  ...
  },
  {
    ...
    name: "吉林文庙",
    description: "吉林省吉林市的著名文庙，以其宏伟的建筑和丰富的历史文化而闻名",
...
// 吉林省季节性数据
const jilinSeasonalData: Record<string, SeasonalScenery> = {
  spring: {
    name: "春季",
...
// 吉林省活动数据
const jilinActivities: TravelActivity[] = [
  {
    id: "1",
    name: "长白山登山",
    description: "攀登长白山，欣赏壮丽的自然风光",
  ...
  },
  {
    id: "2",
    name: "松花湖游船",
    description: "在松花湖上乘坐游船，欣赏美丽的湖光山色",
  ...
  },
  {
    id: "3",
    name: "吉林雾凇观赏",
    description: "观赏吉林市的雾凇奇观，感受大自然的魅力",
  ...
  },
  {
    id: "4",
    name: "朝鲜族民俗体验",
    description: "体验朝鲜族的传统民俗文化，如朝鲜族舞蹈、美食等",
  ...
  },
  {
    id: "5",
    name: "吉林美食之旅",
    description: "品尝吉林特色美食，如延边冷面、长春锅包肉、吉林煎粉等",
...
// 吉林省路线数据
const jilinRoutes: RouteInfo[] = [
  {
    id: "1",
    name: "吉林自然风光之旅",
    title: "吉林自然风光之旅",
    description: "游览吉林最著名的自然景观",
    duration: "5天",
    difficulty: "中等",
    highlights: ["长白山", "松花湖", "净月潭", "吉林雾凇"],
    spots: ["长白山", "松花湖", "净月潭", "吉林雾凇"],
    tags: ["自然", "户外", "休闲"],
...
// 吉林省非物质文化遗产数据
const jilinIntangibleHeritage = [
  {
    id: "1",
    name: "朝鲜族农乐舞",
    description: "吉林省朝鲜族传统舞蹈，以其欢快的节奏和独特的表演风格著称",
    level: "national",
    category: "传统舞蹈",
    heritageType: "传统表演艺术",
    protectionUnit: "吉林省延边朝鲜族自治州文化局",
  ...
  },
  {
    id: "2",
    name: "满族剪纸",
    description: "吉林省满族传统剪纸艺术，以其精美的图案和独特的风格著称",
    level: "national",
    category: "传统美术",
    heritageType: "传统手工艺",
    protectionUnit: "吉林省满族剪纸协会",
  ...
  },
  {
    id: "3",
    name: "朝鲜族跳板",
    description: "吉林省朝鲜族传统体育项目，以其独特的表演形式和竞技性著称",
    level: "national",
    category: "传统体育",
    heritageType: "传统体育、游艺与杂技",
    protectionUnit: "吉林省延边朝鲜族自治州体育局",
  ...
  },
  {
    id: "4",
    name: "东北二人转",
    description: "吉林省传统民间艺术形式，以其幽默风趣的表演风格著称",
    level: "national",
    category: "传统戏剧",
    heritageType: "传统表演艺术",
    protectionUnit: "吉林省二人转艺术协会",
...
export const jilinCustomsData = {
  activities: [
    ...
    },
    {
      id: "2",
      name: "满族剪纸体验",
      description: "学习吉林省满族传统剪纸技艺，体验剪纸的魅力",
...
export const jilinFestivals = [
  ...
  },
  {
    id: "3",
    name: "延边朝鲜族民俗文化节",
    description: "延边朝鲜族自治州举行的民俗文化节庆活动",
    month: "8月",
    day: "1日",
    location: "吉林省延边朝鲜族自治州延吉市",
    isUnique: true
