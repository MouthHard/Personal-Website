...
const jiangxiNatureSpots: ScenerySpot[] = [
  ...
  },
  {
    id: "ganjiangRiver",
    name: "赣江",
    description: "江西省的母亲河，以其美丽的自然风光和丰富的历史文化而闻名",
...
// 江西省人文景观数据
const jiangxiCultureSpots: ScenerySpot[] = [
  {
    id: "nanchangAugustFirstUprisingMemorial",
    name: "南昌八一起义纪念馆",
    description: "江西省南昌市的著名纪念馆，以其丰富的革命历史和文化而闻名",
  ...
  },
  {
    ...
    name: "景德镇陶瓷博物馆",
    description: "江西省景德镇市的著名博物馆，以其丰富的陶瓷文化和历史而闻名",
  ...
  },
  {
    ...
    name: "南昌滕王阁",
    description: "江西省南昌市的著名楼阁，以其宏伟的建筑和丰富的历史文化而闻名",
...
// 江西省季节性数据
const jiangxiSeasonalData: Record<string, SeasonalScenery> = {
  spring: {
    name: "春季",
...
// 江西省活动数据
const jiangxiActivities: TravelActivity[] = [
  {
    id: "1",
    name: "庐山登山",
    description: "攀登庐山，欣赏壮丽的自然风光和独特的云海景观",
  ...
  },
  {
    id: "3",
    name: "景德镇陶瓷制作体验",
    description: "学习景德镇传统陶瓷制作技艺，体验陶瓷的魅力",
  ...
  },
  {
    id: "5",
    name: "江西美食之旅",
    description: "品尝江西特色美食，如南昌瓦罐汤、九江蒸米糕、景德镇粉蒸肉等",
...
// 江西省路线数据
const jiangxiRoutes: RouteInfo[] = [
  {
    id: "1",
    name: "江西山水风光之旅",
    title: "江西山水风光之旅",
    description: "游览江西最著名的山水景观",
    duration: "5天",
    difficulty: "中等",
    highlights: ["庐山", "三清山", "武功山", "鄱阳湖"],
    spots: ["庐山", "三清山", "武功山", "鄱阳湖"],
    tags: ["自然", "山水", "休闲"],
  ...
  },
  {
    ...
    name: "江西文化遗产之旅",
    title: "江西文化遗产之旅",
    description: "探索江西的文化遗产",
    duration: "4天",
    difficulty: "简单",
    highlights: ["婺源", "景德镇陶瓷博物馆", "南昌滕王阁", "井冈山革命旧址"],
    spots: ["婺源", "景德镇陶瓷博物馆", "南昌滕王阁", "井冈山革命旧址"],
    tags: ["历史", "文化", "建筑"],
...
// 江西省非物质文化遗产数据
const jiangxiIntangibleHeritage = [
  {
    id: "1",
    name: "景德镇陶瓷烧制技艺",
  ...
  activities: [
    {
      id: "1",
      name: "景德镇陶瓷烧制体验",
      description: "学习江西省景德镇市传统陶瓷烧制技艺，体验陶瓷的魅力",
    ...
    },
    {
      id: "3",
      name: "瑞昌剪纸体验",
      description: "学习江西省瑞昌市传统剪纸技艺，体验剪纸的魅力",
