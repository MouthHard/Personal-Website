...
import { workTypes, workTypeIcons, workTypeLabels, sortOptions as sortOptionsData } from '@/constants/landscape';
...
import SortIcon from '@/pages/Landscape/icons/components/photographers/AllPhotographers/SortIcon.vue';
import VerifiedBadgeIcon from '@/pages/Landscape/icons/components/photographers/AllPhotographers/VerifiedBadgeIcon.vue';
...
import PanoramaIcon from '@/pages/Landscape/icons/common/PanoramaIcon.vue';
...
import RainbowIcon from '@/pages/Landscape/icons/common/RainbowIcon.vue';
